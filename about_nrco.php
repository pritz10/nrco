...
<section class="w3l-blog-single" id="blog">
  ...
  <div class="container py-lg-5 py-md-4">
    <div class="grids-area-hny main-cont-wthree-fea row">
      <div class="col-lg-4 col-sm-6 grids-feature pb-2">
...
Transfer of technology and capacity building of stakeholders for enhancing and sustaining productivity of orchid.</p>
      ...
      <div class="col-lg-4 col-sm-6 grids-feature mt-sm-0 pb-2">
        <div class="area-box mb-lg-0 shadow">
        <div class="icon">
      ...
      <div class="col-lg-4 col-sm-6 grids-feature mt-lg-0 pb-2">
        <div class="area-box mb-lg-0 shadow">
        <div class="icon">
