...
<!-- Main Body-->
      ...
      <marquee behavior="scroll"  direction="left" scrollamount="6" onmouseover="this.stop()" onmouseout="this.start()">
          <a href="#" class="marq">National Science Day Observed </a>*
          <a href="#"class="marq"> International Womens' Day Celebrated </a>*
          <a href="#"class="marq"> Walk- in- interview will be held 27.03.2021 for the post of Senior Research Fellow (SRF) under National Agriculture Innovation Fund scheme (IPR) purely on temporary basis. </a></marquee>
        </div> 
   ...
   <section class="w3l-main-slider" id="home">
    <div class="companies20-content">
      <div class="owl-one owl-carousel owl-theme">
        <div class="item">
          <li>
            <div class="slider-info banner-view bg bg2" style="background: url('assets/images/PXL_20210228_071705138.jpg'); background-size: cover; background-position: center; background-repeat:  no-repeat;">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-left">
                    <h5>National Science Day</h5>
                    <p>Dikling school students visited on this day.</p>
                    <!-- <a class="btn btn-style btn-white mt-sm-5 mt-4 mr-2" href="#"> Read More</a>
        ...
        <div class="item">
          <li>
            <div class="slider-info  banner-view bg bg2" style="background: url('assets/images/dsc_0238.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;" >
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-left">
                    <h5>International Women's Day</h5>
                    <p>Local farmers and Dikling SSS students were invited</p>
                    <a class="btn btn-style btn-white mt-sm-5 mt-4 mr-2" href="#"> Read More</a>
                   </div>
                </div>
              </div>
...
<section class="w3l-features py-5" id="features">
  <div class="container py-lg-5 py-md-4">
    <div class="middle-section text-center">
      <div class="section-width">
        <h3 class="hny-title py-md-4">Bulletin Board</h3>
       </div>
      </div>
     ...
     <h5 class="mb-1">News / Events </h5>
       ...
       <ul class="list-group left shadow">
         <li class="list-group-item d-flex justify-content-between align-items-center">
          Walk- in- interview will be held 27.03.2021 for the post of Senior Research Fellow (SRF) under National Agriculture Innovation Fund scheme (IPR) purely on temporary basis.
  ...
  <section class="w3l-grids-3 py-5" id="about">
    <div class="container py-md-5 py-3">
      ...
      <div class="bottom-ab-grids align-items-center">
        ...
        <?php
        $records = mysqli_query($connect,"select * from director_message"); // fetch data from database
      ...
      <div class="cwp4-image col-lg-6 pl-lg-5 mb-lg-0 mb-5">
        <img src="assets/images/  " class="img-curve img-fluid" alt="" />
        <div class="text-center">
