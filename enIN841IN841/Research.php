...
<!-- Area Chart -->
 ...
 <h6 class="m-0 font-weight-bold text-white">Research Upload</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show " id="messagedata">
                                    <div class="card-body">
                                    <form method="post" action="Research.php" enctype="multipart/form-data" style="padding:10px;">
...
<div class="card shadow mb-4">
    ...
    <a href="#dataprevious" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-white">Research Management</h6>
                                </a>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="bulletinboard" width="100%" cellspacing="0">
               ...
               <?php  
                    ...
                    $sql = "SELECT * FROM pdfs where Tags IN ('Training','Projects')";  
