...
if($_SERVER['REQUEST_METHOD']=='POST' and $_REQUEST['submit']== 'update')
{
    ...
    $created_date = date("m-d-y ");
    $sql = "UPDATE nrconewdb.bulletin_board set Name='$name', Date='$created_date' where id='$uid'";
    if (mysqli_query($connect, $sql)) {
        if(mysqli_affected_rows($connect) >0 ){
...
<!-- Area Chart -->
 ...
 <h6 class="m-0 font-weight-bold text-white">News/ Events , Opportunity and Tenders</h6>
                                ...
                                <div class="collapse show " id="messagedata">
                                    <div class="card-body">
                                    <form method="post" action="BulletinBoard.php" enctype="multipart/form-data" style="padding:10px;">
