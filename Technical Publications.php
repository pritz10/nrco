...
<section class="w3l-about-breadcrumb text-center">
          <h2 class="title">Technical Publications</h2>
</section>
<div class="container"> 
 ...
 <div class="area-box mb-lg-0 shadow" style="padding:10px;">
                                    ...
                                    Search for any   <strong>  Technical Publications,
      ...
      <table class="table table-hover table-bordered  " id="example" width="100%" cellspacing="0">             
        ...
        <?php  
          ...
          $sql = "SELECT * FROM pdfs where Tags= 'Technical Publications'  ORDER BY Id DESC";  
